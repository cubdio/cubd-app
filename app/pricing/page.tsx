    ...
    <section className="container flex flex-col  gap-6 py-8 md:max-w-[64rem] md:py-12 lg:py-24">
      <div className="mx-auto flex w-full flex-col gap-4 md:max-w-[58rem]">
        ...
        <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
          Unlock all features including all connectors, templates, support and
          more.
        </p>
      </div>
        ...
        <div className="grid gap-6">
          ...
          <ul className="grid gap-3 text-sm text-muted-foreground sm:grid-cols-2">
            <li className="flex items-center">
              <Icons.check className="mr-2 h-4 w-4" /> Unlimited Connectors
            </li>
            <li className="flex items-center">
              <Icons.check className="mr-2 h-4 w-4" /> Unlimited Templates
            </li>

            <li className="flex items-center">
              <Icons.check className="mr-2 h-4 w-4" /> Customer Support
            </li>
            <li className="flex items-center">
